...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "lobbies", function() { return lobbies; });
...
/* harmony export (immutable) */ __webpack_exports__["lobby"] = lobby;
/* harmony export (immutable) */ __webpack_exports__["makePublic"] = makePublic;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lib_peer_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lib_socket_io__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lib_socket_io___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lib_socket_io__);
...
function init() {
    ...
    socket = __WEBPACK_IMPORTED_MODULE_1_lib_socket_io___default()();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_app_app_js__ = __webpack_require__(0);


__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("gameController", function($scope, $location){
    if(!game.started){
        $location.path("lobby");
    }else{
        game.show();
...
__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("homeController", function($scope, $location, $http){
...
__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("lobbiesController", function($scope, $location, $http){
...
__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("lobbyController", function($scope, $location){
    game.hide();
...
__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("loginController", function ($scope, $http, $location, Auth) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_app_app_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_net_network_js__ = __webpack_require__(3);



__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("mainController", function ($scope, $http, $location, Auth) {
    game.hide();
    ...
    $scope.players = __WEBPACK_IMPORTED_MODULE_1_net_network_js__["players"];
    $scope.lobbies = __WEBPACK_IMPORTED_MODULE_1_net_network_js__["lobbies"];
    __WEBPACK_IMPORTED_MODULE_1_net_network_js__["player"](function (players) {
        $scope.players = players;
        $scope.$apply();
    });
    __WEBPACK_IMPORTED_MODULE_1_net_network_js__["lobby"](function(lobbies){
        $scope.lobbies = lobbies;
        $scope.$apply();
    });
    console.log(__WEBPACK_IMPORTED_MODULE_1_net_network_js__["players"]);
    $scope.isServer = function () {
        return __WEBPACK_IMPORTED_MODULE_1_net_network_js__["isServer"];
    }
    $scope.login = function () {
        $location.path("/login");
    }
    ...
    $scope.makePublic = function () {
        __WEBPACK_IMPORTED_MODULE_1_net_network_js__["makePublic"]();
        $scope.public = true;
    };
    $scope.connect = function (peer) {
        $scope.lobbyName = peer.name;
        $location.path("/lobby");
        __WEBPACK_IMPORTED_MODULE_1_net_network_js__["connect"](peer.id);
    }
...
__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].controller("registerController", function($scope, $location, $http){
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_app_app_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_app_maincontroller_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_app_homecontroller_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_app_lobbycontroller_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_app_lobbiescontroller_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_app_gamecontroller_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_app_logincontroller_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_app_registercontroller_js__ = __webpack_require__(20);
...
__WEBPACK_IMPORTED_MODULE_0_app_app_js__["a" /* app */].factory('Auth', ['$cookieStore', function ($cookieStore) {
